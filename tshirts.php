...
<section class="container products">
   ...
   <p class="fs-1 mt-5 py-5 ps-5"> <a  href="home.php">home</a> / all t-shirts </p>

   <div class="box-container">

      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE name LIKE '%t-shirt%'") or die('query failed');
